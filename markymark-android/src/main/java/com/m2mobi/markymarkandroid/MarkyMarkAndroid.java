...
public class MarkyMarkAndroid {
	 ...
	 * @param pFlavor
	 * 		Flavor that provides the markdown parsing rules
	...
	public static MarkyMark<View> getMarkyMark(final Context pContext, final Flavor pFlavor) {
		return getMarkyMark(pContext, pFlavor, null, null);
	}
	 ...
	 * 		Flavor that provides the markdown parsing rules
	 * @param pDisplayItems
	 * 		Extra DisplayItems (replaces DisplayItems that render the same MarkDownItem}
	 * @param pInlineDisplayItems
	 * 		Extra InlineDisplayItems (replaces InlineDisplayItems that render the same MarkDownItem}
	 * @return MarkMark instance that renders MarkyMarkAndroid Views from Markdown
	 */
	public static MarkyMark<View> getMarkyMark(final Context pContext, final Flavor pFlavor,
		...
		viewConverter.addMapping(new ImageDisplayItem(context));
